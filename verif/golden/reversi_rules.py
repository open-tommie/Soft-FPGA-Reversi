...
----------------------------------------------------------------------
本ファイルは Soft-FPGA-Reversi の cocotb / HIL テストの **唯一の golden** として
tommie-chat リポジトリから単純コピーしたもの。当方では改変しない (Verilog の
挙動が Python と異なれば Verilog を直す)。

source : https://github.com/open-tommie/tommie-chat/blob/HEAD/test/reversi/reversi_rules.py
imported: 2026-04-28
----------------------------------------------------------------------
"""
