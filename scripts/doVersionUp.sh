...
# VE_STR_01 / VE_STR_02 行を更新（既存の .NNN サフィックスも上書き）
...
# VE_STR_01_CHARS / VE_STR_02_CHARS 行を更新
...
echo "${RTL_FILE}: VE_STR_01 → \"${NEW_VE_STR_01}\" (${NEW_VE_CHARS_01}), VE_STR_02 → \"${NEW_VE_STR_02}\" (${NEW_VE_CHARS_02})"
